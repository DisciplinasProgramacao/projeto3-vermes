...
public class Estacionamento implements Serializable {
    ...
    /**
     * Constrói um objeto Estacionamento com o nome especificado, número de fileiras
     * no estacionamento e número de vagas por fileira.
     *
     ...
     * @return true se o cliente foi adicionado com sucesso, false se o cliente já
     *         existir.
     */
    ...
    /**
     * Gera as vagas no estacionamento com base no número de fileiras e vagas por
     * fileira.
     */
     ...
     * @throws VagaIndisoponivelException Lança a exceção se a vaga estiver
     *                                    indisponíver
     * @throws LotadoException            Se o estacionamento estiver lotado.
     */
    ...
    /**
     * Retira um veículo com a placa especificada do estacionamento e retorna o
     * valor a ser pago.
     *
    ...
    /**
     * Retorna os nomes dos top 5 clientes com maior arrecadação no mês
     * especificado.
     *
     * @param mes O número do mês (1 a 12).
    ...
    public double arrecadacaoMediaMensalistasNoMesCorrente() {
        ...
        return totalClientesMensalistas > 0 ? totalArrecadacaoMensalistas / totalClientesMensalistas : 0.0;
    }
    ...
    /**
     * Obtém o total de utilizações mensais para clientes mensalistas no mês
     * corrente.
     *
    ...
    public double arrecadacaoMediaHoristasNoMesCorrente() {
        ...
        return totalClientesHoristas > 0 ? totalArrecadacaoHoristas / totalClientesHoristas : 0.0;
    }
    ...
    /**
     * Ordena a lista de estacionamentos pelo valor total arrecadado, em ordem
     * decrescente.
     * 
    ...
    public static void ordenarEstacionamentos(List<Estacionamento> estacionamentos) {
        Collections.sort(estacionamentos,
                Comparator.comparingDouble(Estacionamento::calcularArrecadacaoTotal).reversed());
    }
    ...
    /**
     * Busca um cliente pelo seu respectivo veículo.
     * 
     * @param placa A placa do veículo a ser buscado.
     * @return O cliente encontrado, ou null se não encontrado.
     */
